...
ANCHORS          = utils.get_anchors('./data/train/train_anchors.txt', IMAGE_H, IMAGE_W)
NUM_CLASSES      = len(CLASSES)
STEPS            = int(outputPerSample * NUM_CLASSES/BATCH_SIZE * num_epochs)
EVAL_INTERNAL    = 600
SAVE_INTERNAL    = 600

train_tfrecord   = "./data/train/train.tfrecords"
test_tfrecord    = "./data/train/train.tfrecords"
...
os.system("python convert_weight.py --ckpt_file \'./checkpoint/yolov3.ckpt-%s\' --num_classes 1 --freeze"%(step+1))

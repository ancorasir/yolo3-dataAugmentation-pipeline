...
def compute_anchors(dataset_txt, cluster_num = 9):
    anchors_txt="./data/train/train_anchors.txt"
    ...
    plot_cluster_result(clusters, nearest_clusters, 1-WithinClusterMeanDist, anno_result, cluster_num)
